...
My original goal was to simulate what happens when someone with no software engineering background attempts to vibe-code an entire application, but I quickly learned that with absolutely no constraints, the project would just drive itself into the ground.
